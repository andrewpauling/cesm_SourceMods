...
! !USES:
   ...
   use forcing_fwf_interior
   use forcing_hf_interior
   use forcing_ap
...
!-----------------------------------------------------------------------
   ...
   call init_fwf_interior
   call init_hf_interior
...
!-----------------------------------------------------------------------
   ...
   call get_hf_interior_data   ! AGP copying CMB code below
   call get_fwf_interior_data  ! CMB as per notes for this subroutine
                               ! CMB only data interp is called for interior
                               ! CMB set_fwf_forcing is called in baroclinic.F90
